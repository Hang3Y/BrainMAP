...
if __name__ == "__main__":
    ...
    # active_dataset = "1002_brats2023"
    # active_dataset = "1005_atlasr2"
    # active_dataset = "1007_isles2022"
    # active_dataset = "1010_msd"
    # active_dataset = "1014_ixi"
    # active_dataset = "1016_l2r"
    # active_dataset = "1017_mets"
    # active_dataset = "1019_lumiere"
    active_dataset = "1020_wmh"
    # active_dataset = "1021_ucsd_ptgbm"
    # active_dataset = "1022_upenn_gbm"
    # active_dataset = "1023_ucsf_pdgm"
    # active_dataset = "1024_remind"
    # active_dataset = "1030_nigerian_clinical_mri"

    selected_input_dir = script_dir / dataset_inputs[active_dataset]
    audit_summary = run_metadata_audit(
        input_dir=selected_input_dir,
        num_workers=8,
        resume=True,
    )
    raise SystemExit(exit_code_from_summary(audit_summary))
