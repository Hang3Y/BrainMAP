"""MNI-space MRI preprocessing for BrainMAP image volumes only.

This script intentionally does not process segmentation labels. It saves the
ANTs affine transform and spatial sidecar metadata needed by a later label
...
if __name__ == "__main__":
    ...
    template_image = script_dir / "MNI152NLin2009aSym.nii.gz"
    dataset_inputs = {
        "1001_abideii": "1001_abideii/abide_fm_ready_skull_stripping_n4",
        "1002_brats2023": "1002_brats2023/brats_fm_ready",
        "1005_atlasr2": "1005_atlasr2/atlas_fm_ready_skull_stripping_n4",
        "1007_isles2022": "1007_isles2022/isles_fm_ready_n4",
        "1010_msd": "1010_msd/msd_fm_ready",
        "1014_ixi": "1014_ixi/ixi_fm_ready_skull_stripping_n4",
        "1016_l2r": "1016_l2r/l2r_fm_ready",
        "1017_mets": "1017_mets/mets_fm_ready",
        "1019_lumiere": "1019_lumiere/lumiere_fm_ready",
        "1020_wmh": "1020_wmh/wmh_fm_ready_skull_stripping_n4",
        "1021_ucsd_ptgbm": "1021_ucsd_ptgbm/ucsd_ptgbm_fm_ready",
        "1022_upenn_gbm": "1022_upenn_gbm/upenn_gbm_fm_ready",
        "1023_ucsf_pdgm": "1023_ucsf_pdgm/ucsf_pdgm_fm_ready",
        "1024_remind": "1024_remind/remind_fm_ready_n4",
        "1030_nigerian_clinical_mri": "1030_nigerian_clinical_mri/curated_fm_ready_skull_stripping_n4",
    }

    # active_dataset = "1001_abideii"    # TODO 1   1194 - DONE
    # active_dataset = "1002_brats2023"  # TODO 2   5880 - DONE
    # active_dataset = "1005_atlasr2"    # TODO 3   955 - DONE
    # active_dataset = "1007_isles2022"  # TODO 4   250 - DONE
    # active_dataset = "1010_msd"        # TODO 5   3000 - DONE
    # active_dataset = "1014_ixi"        # TODO 6   1159 - DONE
    # active_dataset = "1016_l2r"        # TODO 7   453 - DONE
    # active_dataset = "1017_mets"       # TODO 8   624 - DONE
    # active_dataset = "1019_lumiere"    # TODO 9   1600 - DONE
    # active_dataset = "1020_wmh"        # TODO 10  510 - DONE
    # active_dataset = "1021_ucsd_ptgbm" # TODO 11  959 - DONE
    # active_dataset = "1022_upenn_gbm"  # TODO 12  2684 - DONE
    active_dataset = "1023_ucsf_pdgm"  # TODO 13  2004 - DONE
    # active_dataset = "1024_remind"     # TODO 14  523 - DONE
    # active_dataset = "1030_nigerian_clinical_mri"

    selected_input_dir = script_dir / dataset_inputs[active_dataset]
    processing_summary = run_mni_preprocessing(
        input_dir=selected_input_dir,
        template_path=template_image,
        num_workers=6,
        ants_threads_per_worker=8,
        target_xy=(224, 224),
        nonzero_threshold=0.20,
        trim_slices_each_end=3,
...
# 更快，适合服务器空闲时
num_workers=6
ants_threads_per_worker=8   # 约 60 threads
